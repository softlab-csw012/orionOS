...
bool bin_load_image(const char* path, uintptr_t* out_entry, uintptr_t* out_image_base,
                    uint32_t* out_image_size, uintptr_t* out_load_base);
void jump_to_bin(uintptr_t entry, uintptr_t stack_top);
void bin_return_to_shell(void);
void bin_exit_trampoline(void);
extern uintptr_t bin_saved_rsp;
