...
bool ksys_handle_gui(registers_t* regs) {
    ...
    switch (eax) {
        ...
        case SYS_GUI_SEND: {
            ...
            sys_gui_msg_t msg = *(sys_gui_msg_t*)(uintptr_t)ebx;
            msg.sender_pid = proc_current_pid();
            uintptr_t flags = console_lock_acquire();
        ...
        case SYS_GUI_RECV: {
            ...
            memcpy((void*)(uintptr_t)ebx, &msg, sizeof(msg));
            regs->eax = 1;
            return true;
        }
        ...
        case SYS_GUI_SEND_TO: {
            ...
            sys_gui_msg_t msg = *(sys_gui_msg_t*)(uintptr_t)ecx;
