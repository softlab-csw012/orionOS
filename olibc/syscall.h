...
#define SYS_KEYBOARD_INPUT_MODE 77
#define SYS_GETKEY_EVENT   78
#define SYS_GETKEY_EVENT_NB 79
...
#define SYS_IME_BIND       205
#define SYS_IME_RECV       206
#define SYS_IME_SEND       207
#define SYS_IME_PROCESS    208
...
typedef struct sys_key_event sys_key_event_t;
...
typedef struct {
    ...
    uint32_t commit[2];
    uint32_t commit_count;
} sys_ime_kernel_res_t;

struct sys_key_event {
    uint8_t code;
    uint8_t modifiers;
    uint8_t toggles;
    uint8_t reserved;
...
enum {
    SYS_KEY_MOD_SHIFT = 1u << 0,
    SYS_KEY_MOD_CTRL  = 1u << 1,
    SYS_KEY_MOD_ALT   = 1u << 2,
};

enum {
    SYS_KEY_TOGGLE_CAPS   = 1u << 0,
    SYS_KEY_TOGGLE_NUM    = 1u << 1,
    SYS_KEY_TOGGLE_SCROLL = 1u << 2,
    SYS_KEY_TOGGLE_KOREAN = 1u << 3,
};

enum {
    SYS_IME_KEY_CHAR = 0,
    SYS_IME_KEY_BACKSPACE = 1,
    SYS_IME_KEY_ENTER = 2,
    SYS_IME_KEY_TAB = 3,
    SYS_IME_KEY_RESET = 4,
    SYS_IME_KEY_LEFT = 5,
    ...
    SYS_IME_KEY_HOME = 9,
    SYS_IME_KEY_END = 10,
    SYS_IME_KEY_DELETE = 11,
    SYS_IME_KEY_TOGGLE = 12,
};

enum {
    SYS_IME_MOD_SHIFT = 1u << 0,
    SYS_IME_MOD_CTRL  = 1u << 1,
    SYS_IME_MOD_ALT   = 1u << 2,
};
...
#define getkey_event      sys_getkey_event
#define getkey_event_nb   sys_getkey_event_nb
